---
description: Normalize a concrete request into one operator-locked Work Brief 2.0.0 with a persisted artifact handoff.
argument-hint: "<concrete-request-or-raw-intent-path>"
